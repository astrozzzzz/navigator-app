...
// Если за это время карта так и не сообщила о готовности, показываем ошибку с возможностью повторить.
...
export default function Map({ markers, userLocation, onLongPress, onMarkerPress }: MapProps) {
	...
	const orderedMarkers = useMemo(() => [...shownMarkers].sort((a, b) => a.id - b.id), [shownMarkers]);
