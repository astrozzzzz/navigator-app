...
export const DEFAULT_LOCATION_CONFIG: LocationConfig = {
  // High — чтобы использовался GPS. С Balanced Android берёт координаты из сети,
  // а на эмуляторе сетевой геолокации нет, и обновления не приходят вовсе.
...
export async function startLocationUpdates(
  ...
  // watchPositionAsync не отдаёт закэшированную позицию, поэтому показываем её сразу,
  // не дожидаясь первого свежего фикса.
